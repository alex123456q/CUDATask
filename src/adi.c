...
void xinvr()
{
    ...
    (cudaMemcpy(gpuVs, vs, size, cudaMemcpyHostToDevice));
    (cudaMemcpy(gpuWs, ws, size, cudaMemcpyHostToDevice));
    (cudaMemcpy(gpuQs, qs, size, cudaMemcpyHostToDevice));
    ...
    cudaEventElapsedTime( &timet, start, stop);
